...
<html>
    ...
    <header>
    <p>
     <a href= "../ExpenseTracker/Serch_category.php"><strong>Return</strong></a></p>
    </header>
  </body>
...
?>
 ...
 <form method="POST">
    ...
    <input type="text"  id='no'name="Write_a_note" value="<?php echo $data['Write_a_note'] ?>" placeholder="Enter note" >
</p>  
